...
def parse_args():
    ...
    # validation settings
    parser.add_argument("--validation_prompt", type=str, default='A pokemon with blue eyes.', help="A prompt that is sampled during training for inference.")
...
def train_lora(dataset_name, cur_output_dir, train_data_dir, num_train_epochs):
    args = parse_args()
    if dataset_name == 'face':
        args.validation_prompt = 'A portrait of a young woman smiling.'
    elif dataset_name == 'pokemon':
        args.validation_prompt = 'A pokemon with blue eyes.'
    ...
    if args.dataset_name is not None:
        ...
        dataset = load_dataset(
            "csv",
            data_files=args.train_data_dir + dataset_name + ".csv"
        )
